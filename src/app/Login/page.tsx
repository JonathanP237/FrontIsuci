...
import { FaLinkedin, FaGoogle, FaFacebookF } from 'react-icons/fa';
...
const Login = () => {
  ...
  return (
      <div className="flex flex-col w-full h-screen items-center justify-center min-h-screen py-2 bg-gray-100">
        <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
          <div className="bg-white rounded-2xl shadow-2xl flex w-2/3 max-4xl">
            ...
            <div className="w-3/5 p-5 text-black">
              ...
              <div className="py-10">
                <h2 className="text-3xl font-bold mb-2 text-red-600">Iniciar Sesión</h2>
                <div className="border-2 w-10 border-red-600 inline-block mb-2"></div>
                <div className="flex justify-center my-2">
                  <a href="#" className="border-2 border-gray-200 rounded-full p-3 mx-1">
                    <FaFacebookF className="text-5m" /> {/* Icono para ingresar por Facebook */}
                  </a>
                  <a href="#" className="border-2 border-gray-200 rounded-full p-3 mx-1">
                    <FaLinkedin className="text-5m" /> {/* Icono para ingresar por LinkedIn */}
                  </a>
                  <a href="#" className="border-2 border-gray-200 rounded-full p-3 mx-1">
                    <FaGoogle className="text-5m" /> {/* Icono para ingresar por Gmail */}
                  </a>
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col items-center w-full">
                  ...
                  <div className="flex justify-between w-64 mb-5">
                    ...
                    <a href="#" className="text-xs">Olvidó su contraseña?</a>
                  </div>
                  <button
                    type="submit"
